{ lib, fetchFromGitHub, glib-networking, gst_all_1, gtk3, help2man, luajit
, luajitPackages, pkg-config, sqlite, stdenv, webkitgtk_4_1, wrapGAppsHook3, }:

let inherit (luajitPackages) luafilesystem;
in stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-WbxovaYGVz/yoZB7h0CuJOi0ChhHrBse01y9BvbaQ1Q=";
  };

  nativeBuildInputs = [ luajit pkg-config help2man wrapGAppsHook3 ];
